<?php
// FILE: admin/patient_add.php (ENHANCED UI/UX VERSION)
require 'includes/header.php';
?>

<!-- =================================================================
     NEW: CUSTOM STYLES FOR THE ENHANCED ACCORDION FORM
     ================================================================= -->
<style>
    .accordion-button {
        font-size: 1.1rem;
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a href="patients.php" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Cancel & Go Back</a>
</div>

<div class="alert alert-light" role="alert">
  Please complete all sections below. Sections marked with a <span class="text-danger">*</span> are required.
</div>

<!-- The form tag now wraps the entire accordion -->
<form action="patient_add_process.php" method="POST" id="patientForm">
    ...
    <div class="accordion" id="patientRegistrationAccordion">
      ...
      <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#patientRegistrationAccordion">
          <div class="accordion-body">
            <div class="row g-3">
                <div class="col-md-4"><label for="last_name" class="form-label"><i class="fas fa-user"></i>Last Name <span class="text-danger">*</span></label><input type="text" class="form-control" id="last_name" name="last_name" required></div>
                <div class="col-md-4"><label for="first_name" class="form-label"><i class="fas fa-user"></i>First Name <span class="text-danger">*</span></label><input type="text" class="form-control" id="first_name" name="first_name" required></div>
                <div class="col-md-4"><label for="middle_name" class="form-label"><i class="fas fa-user"></i>Middle Name</label><input type="text" class="form-control" id="middle_name" name="middle_name"></div>
                <div class="col-12"><label for="address" class="form-label"><i class="fas fa-map-marker-alt"></i>Address <span class="text-danger">*</span></label><input type="text" class="form-control" id="address" name="address" required></div>
                <div class="col-md-3"><label for="birthdate" class="form-label"><i class="fas fa-calendar-alt"></i>Birthdate <span class="text-danger">*</span></label><input type="date" class="form-control" id="birthdate" name="birthdate" required> <span id="ageDisplay" class="text-muted ms-2"></span></div>
                <div class="col-md-2"><label for="gender" class="form-label"><i class="fas fa-venus-mars"></i>Gender <span class="text-danger">*</span></label><select id="gender" name="gender" class="form-select" required><option selected disabled value="">...</option><option value="M">Male</option><option value="F">Female</option></select></div>
                <div class="col-md-2"><label for="nickname" class="form-label"><i class="fas fa-user-tag"></i>Nickname</label><input type="text" class="form-control" id="nickname" name="nickname"></div>
                <div class="col-md-3"><label for="civil_status" class="form-label"><i class="fas fa-ring"></i>Civil Status <span class="text-danger">*</span></label><input type="text" class="form-control" id="civil_status" name="civil_status" required></div>
                <div class="col-md-2"><label for="nationality" class="form-label"><i class="fas fa-flag"></i>Nationality</label><input type="text" class="form-control" id="nationality" name="nationality"></div>
                <div class="col-md-4"><label for="occupation" class="form-label"><i class="fas fa-briefcase"></i>Occupation</label><input type="text" class="form-control" id="occupation" name="occupation"></div>
                <div class="col-md-4"><label for="religion" class="form-label"><i class="fas fa-pray"></i>Religion</label><input type="text" class="form-control" id="religion" name="religion"></div>
                <div class="col-md-4"><label for="mobile_no" class="form-label"><i class="fas fa-mobile-alt"></i>Mobile # <span class="text-danger">*</span></label><input type="tel" class="form-control" id="mobile_no" name="mobile_no" required></div>
                <div class="col-md-6"><label for="parent_guardian_name" class="form-label"><i class="fas fa-users"></i>For Minors: Parent/Guardian's Name</label><input type="text" class="form-control" id="parent_guardian_name" name="parent_guardian_name"></div>
                <div class="col-md-6"><label for="parent_guardian_occupation" class="form-label"><i class="fas fa-user-tie"></i>For Minors: Parent/Guardian's Occupation</label><input type="text" class="form-control" id="parent_guardian_occupation" name="parent_guardian_occupation"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#patientRegistrationAccordion">
          <div class="accordion-body">
            <div class="row g-3">
                <div class="col-md-6"><label for="chief_complaint" class="form-label"><i class="fas fa-comment-medical"></i>Chief Complaint <span class="text-danger">*</span></label><textarea class="form-control" id="chief_complaint" name="chief_complaint" rows="2" required></textarea></div>
                <div class="col-md-6"><label for="history_of_present_illness" class="form-label"><i class="fas fa-file-medical-alt"></i>History of Present Illness</label><textarea class="form-control" id="history_of_present_illness" name="history_of_present_illness" rows="2"></textarea></div>
                <div class="col-md-6"><label for="previous_dentist" class="form-label"><i class="fas fa-user-md"></i>Previous Dentist</label><input type="text" class="form-control" id="previous_dentist" name="previous_dentist"></div>
                <div class="col-md-6"><label for="last_dental_visit" class="form-label"><i class="fas fa-calendar-check"></i>Last Dental Visit</label><input type="date" class="form-control" id="last_dental_visit" name="last_dental_visit"></div>
      ...
      <div class="accordion-item">
        ...
        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#patientRegistrationAccordion">
          <div class="accordion-body">
            <div class="row g-3">
                <div class="col-md-5"><label for="physician_name" class="form-label"><i class="fas fa-user-md"></i>Name of Physician</label><input type="text" class="form-control" id="physician_name" name="physician_name"></div>
                <div class="col-md-4"><label for="physician_address" class="form-label"><i class="fas fa-map-marker-alt"></i>Address</label><input type="text" class="form-control" id="physician_address" name="physician_address"></div>
                <div class="col-md-3"><label for="physician_phone" class="form-label"><i class="fas fa-phone"></i>Phone Number</label><input type="tel" class="form-control" id="physician_phone" name="physician_phone"></div>
                <div class="col-md-12"><label for="last_physical_exam" class="form-label"><i class="fas fa-calendar-alt"></i>Date of Last Physical Examination</label><input type="date" class="form-control" id="last_physical_exam" name="last_physical_exam"></div>
                <hr class="my-4">
      ...
      <div class="accordion-item">
        ...
        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#patientRegistrationAccordion">
          <div class="accordion-body">
              <div class="row">
                <div class="col-md-3"><label class="form-label"><i class="fas fa-tint"></i>Blood Pressure:</label><input type="text" class="form-control" name="blood_pressure" placeholder="e.g., 120/80"></div>
                <div class="col-md-3"><label class="form-label"><i class="fas fa-lungs"></i>Respiratory Rate:</label><input type="text" class="form-control" name="respiratory_rate" placeholder="e.g., 16"></div>
                <div class="col-md-3"><label class="form-label"><i class="fas fa-heartbeat"></i>Pulse Rate:</label><input type="text" class="form-control" name="pulse_rate" placeholder="e.g., 72"></div>
                <div class="col-md-3"><label class="form-label"><i class="fas fa-thermometer-half"></i>Temperature:</label><input type="text" class="form-control" name="temperature" placeholder="e.g., 36.5°C"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 mt-4 text-center">
        <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save me-2"></i>Save Patient and Medical History</button>
    </div>
