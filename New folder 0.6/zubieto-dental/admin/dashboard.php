...
<!-- KPI CARDS -->
<div class="row">
    <div class="col-md-4"><div class="card text-white bg-success mb-3"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div><h5 class="card-title">Revenue (This Month)</h5><h2 class="card-text">₱<?php echo number_format($monthly_revenue, 2); ?></h2></div><i class="fas fa-dollar-sign fa-3x"></i></div></div></div></div>
    <div class="col-md-4"><div class="card text-white bg-primary mb-3"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div><h5 class="card-title">New Patients (This Month)</h5><h2 class="card-text"><?php echo $new_patients_month; ?></h2></div><i class="fas fa-user-plus fa-3x"></i></div></div></div></div>
    <div class="col-md-4"><div class="card text-white bg-info mb-3"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div><h5 class="card-title">Appointments Completed</h5><h2 class="card-text"><?php echo $appts_completed_month; ?></h2></div><i class="fas fa-check-circle fa-3x"></i></div></div></div></div>
</div>
...
<div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <thead class="table-light">
                            <tr><th>Time</th><th>Patient</th><th>Service</th><th class="text-center">Status</th><th class="text-center">Actions</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr><td colspan="5"><div class="alert alert-light text-center mb-0">No appointments scheduled for today.</div></td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-lg-5">
        ...
        <div class="card"><div class="card-body"><div class="table-responsive"><table class="table table-hover"><thead class="table-light"><tr><th>Patient</th><th class="text-end">Balance</th><th class="text-center">Actions</th></tr></thead><tbody>
            <?php if ($outstanding_result && $outstanding_result->num_rows > 0): ?>
                <?php while($bal = $outstanding_result->fetch_assoc()): ?>
                    <tr><td><?php echo htmlspecialchars($bal['last_name'] . ', ' . $bal['first_name']); ?></td><td class="text-end text-danger fw-bold">₱<?php echo number_format($bal['total_balance'], 2); ?></td><td class="text-center"><a href="patient_view.php?id=<?php echo $bal['patient_id']; ?>" class="btn btn-info btn-sm" title="View Patient Record"><i class="fas fa-eye"></i></a></td></tr>
                <?php endwhile; ?>
            <?php else: ?>
                <tr><td colspan="3"><div class="alert alert-light text-center mb-0">No outstanding balances.</div></td></tr>
            <?php endif; ?>
