<?php
// FILE: admin/patient_edit_process.php (MODIFIED)
...
try {
    ...
    $sql_patient = "UPDATE patients SET 
        ...
        mobile_no='$mobile_no', parent_guardian_name='$parent_guardian_name', parent_guardian_occupation='$parent_guardian_occupation',
