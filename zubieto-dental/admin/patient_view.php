<?php
// FILE: admin/patient_view.php (FINAL - WITH TAB PERSISTENCE)
...
// =========================================================================
// THE FIX IS HERE (PART 1): GET THE ACTIVE TAB FROM URL OR SET A DEFAULT
// =========================================================================
...
<!-- =========================================================================
     THE FIX IS HERE (PART 2): DYNAMICALLY ADD 'active' CLASS TO TABS
     ========================================================================= -->
...
<!-- =========================================================================
     THE FIX IS HERE (PART 3): DYNAMICALLY ADD 'show active' TO TAB PANES
     ========================================================================= -->
<div class="tab-content card" id="patientTabContent">
  ...
  <div class="tab-pane fade <?php if($active_tab == 'profile') echo 'show active'; ?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
    <!-- ... Patient Profile Content (no change needed inside) ... -->
    <div class="row">
        <!-- Left Column -->
        <div class="col-lg-7">
  ...
  <div class="tab-pane fade <?php if($active_tab == 'medical-history') echo 'show active'; ?>" id="medical-history" role="tabpanel" aria-labelledby="medical-history-tab">
    <!-- ... Medical History Content (no change needed inside) ... -->
        ...
        <div class="alert alert-warning warning-alert" role="alert">
            ...
            <?php 
                ...
                if (!empty($yes_conditions)) {
                    echo '<p>' . implode(' • ', array_map('htmlspecialchars', $yes_conditions)) . '</p>';
                } else { echo '<p class="mb-0">No major conditions reported.</p>'; }
  ...
  <div class="tab-pane fade <?php if($active_tab == 'findings') echo 'show active'; ?>" id="findings" role="tabpanel" aria-labelledby="findings-tab">
    <!-- ... Clinical Findings Content (no change needed inside) ... -->
  ...
  <div class="tab-pane fade <?php if($active_tab == 'treatments') echo 'show active'; ?>" id="treatments" role="tabpanel" aria-labelledby="treatments-tab">
    <!-- ... Treatment Record Content (no change needed inside) ... -->
...
<!-- All Modals and Scripts (No changes needed) -->
<!-- ... (The modal and script section remains the same as before) ... -->
<!-- ALL MODALS (No changes needed) -->
