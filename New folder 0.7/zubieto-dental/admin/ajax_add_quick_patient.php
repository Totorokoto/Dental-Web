...
try {
    // Prepare SQL to insert a minimal patient record
    $sql_patient = "INSERT INTO patients (first_name, last_name, mobile_no, branch, birthdate, age, gender, civil_status, address, chief_complaint, history_of_present_illness) VALUES (?, ?, ?, ?, '1900-01-01', 0, 'M', 'N/A', 'N/A', 'For Registration', 'For Registration')";
    $stmt_patient = $conn->prepare($sql_patient);
    $stmt_patient->bind_param("ssss", $first_name, $last_name, $mobile_no, $branch);
