...
<main class="main-content-area">
    ...
    <div class="patient-form-content">
         <form id="addPatientForm" method="post" action="create_patient.php">
            ...
            <div class="data-grid">
                <!-- All original patient info fields remain the same -->
                 <div class="data-item">
            ...
            <div class="data-grid">
                <?php
                    // MODIFICATION: Added 'LowBloodPressure'
                    $medical_fields = [
                    ...
                    $medical_booleans = [
                        ...
                        'HighBloodPressure' => 'High Blood Pressure', 'LowBloodPressure' => 'Low Blood Pressure', // ADDED
                        'EpilepsyConvulsions' => 'Epilepsy/Convulsions', 'AIDSOrHIVInfection' => 'AIDS/HIV', 'StomachTroublesUlcer' => 'Stomach Troubles/Ulcer',
                ...
                <!-- NEW: Contextual Detail Textareas -->
                <div class="data-item">
                    <label for="TreatmentDetails">If under medical treatment, please specify condition:</label>
                    <textarea id="TreatmentDetails" name="TreatmentDetails"></textarea>
                </div>
                <div class="data-item">
                    <label for="IllnessDetails">If had serious illness/operation, please specify:</label>
                    <textarea id="IllnessDetails" name="IllnessDetails"></textarea>
                </div>
                <div class="data-item">
                    <label for="HospitalizationDetails">If ever hospitalized, please specify when and why:</label>
                    <textarea id="HospitalizationDetails" name="HospitalizationDetails"></textarea>
                </div>

                <!-- NEW: Lifestyle Questions -->
                 <div class="data-item">
                    <label for="DietaryRestrictions">Are you taking any diet drugs or pills? If yes, specify:</label>
                    <textarea id="DietaryRestrictions" name="DietaryRestrictions"></textarea>
                </div>
                 <div class="data-item">
                    <label for="UseAlcohol">Do you drink alcoholic beverages? If yes, how much:</label>
                    <input type="text" id="UseAlcohol" name="UseAlcohol">
                </div>
                 <div class="data-item">
                    <label for="UseTobacco">Do you use tobacco? (e.g., cigarettes, vape, snuff, chew)</label>
                    <input type="text" id="UseTobacco" name="UseTobacco">
                </div>

                <!-- MODIFIED: Allergy Section -->
                <div class="data-item grid-span-all">
                    <label>Are you allergic to any of the following?</label>
                    <div class="checkbox-container">
                        <div class="checkbox-option"><input type="checkbox" id="AllergyToAnesthetics" name="AllergyToAnesthetics" value="1"><label for="AllergyToAnesthetics">Local Anesthetics (Lidocaine)</label></div>
                        <div class="checkbox-option"><input type="checkbox" id="AllergyToAspirin" name="AllergyToAspirin" value="1"><label for="AllergyToAspirin">Aspirin</label></div>
                        <div class="checkbox-option"><input type="checkbox" id="AllergyToLatex" name="AllergyToLatex" value="1"><label for="AllergyToLatex">Latex</label></div>
                        <div class="checkbox-option"><input type="checkbox" id="AllergyToPenicillin" name="AllergyToPenicillin" value="1"><label for="AllergyToPenicillin">Penicillin / Antibiotics</label></div>
                    </div>
                    <label for="allergies" class="mt-2">Other allergies, please specify:</label>
                    <textarea id="allergies" name="allergies" placeholder="e.g., Sulfa Drugs, Nuts, etc."></textarea>
                </div>
            ...
            <div class="data-grid">
                ...
                <!-- NEW: Past Procedures Done -->
                <div class="data-item grid-span-all">
                    <label>Procedures Done in the Past (Check which apply)</label>
                    <div class="checkbox-container">
                        <?php $past_procedures = ['Perio', 'Resto', 'O.S.', 'Prostho', 'Endo', 'Ortho']; ?>
                        <?php foreach($past_procedures as $proc): ?>
                        <div class="checkbox-option">
                            <input type="checkbox" id="past_<?php echo $proc; ?>" name="pastProcedures[]" value="<?php echo $proc; ?>">
                            <label for="past_<?php echo $proc; ?>"><?php echo $proc; ?></label>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    <label for="pastProceduresOther" class="mt-2">Other past procedures, please specify:</label>
                    <input type="text" id="pastProceduresOther" name="pastProceduresOther">
                </div>
                <div class="data-item">
            ...
            <!-- NEW: Consent Section -->
            <div class="data-item grid-span-all mt-4">
                 <p>I hereby certify that all entries made in this health history form are true and correct to the best of my knowledge. I fully understand that any untoward incident that may occur as a direct result of any false entry in any of the above questions will release the persons involved in delivering care to me from any legal and moral obligation.</p>
                 <p>I also give my consent to the performance of the recommended dental procedures, operations, and/or treatments that may be considered necessary to restore my oral and dental health.</p>
                 <div class="checkbox-option">
                    <input type="checkbox" id="consent" name="consent" required>
                    <label for="consent"><b>By checking this box, I acknowledge and agree to the statements above.</b></label>
                 </div>
            </div>
